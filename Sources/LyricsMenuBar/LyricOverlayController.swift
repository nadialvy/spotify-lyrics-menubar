...
private final class LyricOverlayView: NSView {
    fileprivate static let currentLyricColor = NSColor(calibratedRed: 1.00, green: 0.86, blue: 0.18, alpha: 1.00)
    ...
    private enum Palette {
        static let current = LyricOverlayView.currentLyricColor
    }
...
private final class LyricProgressView: NSView {
    ...
    private func setup() {
        ...
        fillLayer.backgroundColor = LyricOverlayView.currentLyricColor.withAlphaComponent(0.92).cgColor
